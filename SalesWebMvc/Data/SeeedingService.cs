...
{
    public class SeeedingService
    {
        private SalesWebMvcContext _context;

        public SeeedingService(SalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            {
                return; // o banco de dados já encontra-se populado
            }
            ...
            Seller s5 = new Seller(5, "Donad Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
